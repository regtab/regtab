...
public final class Recordset {
    ...
    // Настройка разделения составных компонентов,
...
//        }
    ...
    public boolean hasNamedAttributes() {
        for (Attribute attribute : attributes) {
            if (!attribute.isAutogeneratedName())
                return true;
        }
    ...
    public String[] header(boolean useAutogeneratedNaming) {

        final int size = attributes.size();
        final String[] header = new String[size];

        if (useAutogeneratedNaming) {
            for (int i = 0; i < size; i++) {
                header[i] = attributes.get(i).getName();
            }
        } else {
    ...
    void complete() {
        ...
        for (int i = 0; i < maxRecordSize; i++) {
            ...
            if (currentAttr != null) {
                ...
                currentAttr = new Attribute(attrName, null, true);
    ...
    public static final class Attribute {
        ...
        @Getter
        private final boolean autogeneratedName;

        private Attribute(@NonNull String name, Component provenance, boolean autogeneratedName) {
            this.name = name;

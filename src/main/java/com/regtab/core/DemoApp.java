...
public final class DemoApp {
    ...
    private static void extractFromCSV(File csvFile, String ttl) throws IOException {
        final CSVReader reader = new CSVReader();
        final ITable table = reader.readTable(csvFile);
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (true) {
            ...
            extractFromCSV(new File("../../data/rtl/csv/0.csv"), sb.toString());
            sb.setLength(0);
